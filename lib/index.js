...
var chimeeLoading = _interopDefault(require('chimee-plugin-loading'));
...
var ChimeePlayer = function (_Chimee) {
  ...
  function ChimeePlayer(config) {
    ...
    var innerPlugins = [chimeeControl.name, chimeeCenterState.name, chimeeLoading.name, chimeeContextmenu.name, chimeeLog.name];
